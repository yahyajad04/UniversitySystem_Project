...
namespace API_Consumer_University_test1.Controllers
{
    ...
    {
        Uri address_GetStudents = new Uri("https://university-api-dag5drgrauh3fzbp.uaenorth-01.azurewebsites.net/api/Students");
        ...
        public async Task<IActionResult> Enroll()
        {
            ...
            HttpResponseMessage response = await _httpClient.GetAsync("https://university-api-dag5drgrauh3fzbp.uaenorth-01.azurewebsites.net/api/Courses");
            if (response.IsSuccessStatusCode)
            {
        ...
        public async Task<IActionResult> EnrollCourse(int courseId)
        {
            ...
            HttpResponseMessage response2 = _httpClient.GetAsync("https://university-api-dag5drgrauh3fzbp.uaenorth-01.azurewebsites.net/api/Courses").Result;
            ...
            HttpResponseMessage response1 = await _httpClient.GetAsync($"https://university-api-dag5drgrauh3fzbp.uaenorth-01.azurewebsites.net/api/Students/byUser/{userId}");
            ...
            var response = await _httpClient.PostAsync($"https://university-api-dag5drgrauh3fzbp.uaenorth-01.azurewebsites.net/api/Students/{StudentId}/courses", content);
            if (response.IsSuccessStatusCode)
            {
                var putUrl = $"https://university-api-dag5drgrauh3fzbp.uaenorth-01.azurewebsites.net/api/Students/{StudentId}/reciept?hours_term={student.hours_term}&reciept={student.reciept}";
        ...
        public async Task<IActionResult> Unroll(int courseId)
        {
            ...
            var content = new FormUrlEncodedContent(values);
            var response = await _httpClient.PostAsync($"https://university-api-dag5drgrauh3fzbp.uaenorth-01.azurewebsites.net/api/Students/{StudentId}/courses/unroll", content);
            if (response.IsSuccessStatusCode)
            {
                var putUrl = $"https://university-api-dag5drgrauh3fzbp.uaenorth-01.azurewebsites.net/api/Students/{StudentId}/reciept?hours_term={student.hours_term}&reciept={student.reciept}";
                var putResponse = await _httpClient.PutAsync(putUrl, null);
        ...
        public async Task<IActionResult> CreateStudent()
        {
            ...
            HttpResponseMessage response = await _httpClient.GetAsync("https://university-api-dag5drgrauh3fzbp.uaenorth-01.azurewebsites.net/api/Majors");
            if (response.IsSuccessStatusCode)
            {
                string data = await response.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> CreateStudent(Students student)
        {
            ...
            List<Majors> majors = new List<Majors>();
            HttpResponseMessage response2 = _httpClient.GetAsync("https://university-api-dag5drgrauh3fzbp.uaenorth-01.azurewebsites.net/api/Majors").Result;
            if (response2.IsSuccessStatusCode)
            {
        ...
        {
            var student = await _httpClient.GetFromJsonAsync<Students>($"https://university-api-dag5drgrauh3fzbp.uaenorth-01.azurewebsites.net/api/Students/{id}");
        ...
        public async Task<IActionResult> EditStudentAdmin(int id,string name,string email, int hours_term , double reciept)
        {
            ...
            var putUrl = $"https://university-api-dag5drgrauh3fzbp.uaenorth-01.azurewebsites.net/api/Students/{id}/Admin?Name={name}&Email={email}&hours_term={hours_term}&reciept={reciept}";
            var putResponse = await _httpClient.PutAsync(putUrl, null);
            if (!putResponse.IsSuccessStatusCode)
            {
        ...
        public async Task<IActionResult> EditStudent(int id, string name, string email, string Phone)
        {
            ...
            var putUrl = $"https://university-api-dag5drgrauh3fzbp.uaenorth-01.azurewebsites.net/api/Students/{id}/Profile?Name={name}&Email={email}&Phone={Phone}";
            var putResponse = await _httpClient.PutAsync(putUrl, null);
            if (!putResponse.IsSuccessStatusCode)
            {
                TempData["ErrorMessage"] = "Failed to Edit values.";
