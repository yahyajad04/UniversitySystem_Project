...
namespace API_Consumer_University_test1.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            HttpResponseMessage response1 = await _httpClient.GetAsync("https://university-api-dag5drgrauh3fzbp.uaenorth-01.azurewebsites.net/api/Courses");
            ...
            HttpResponseMessage response2 = await _httpClient.GetAsync("https://university-api-dag5drgrauh3fzbp.uaenorth-01.azurewebsites.net/api/Majors");
            if (response1.IsSuccessStatusCode)
